...
var Select =
  ...
  (function(_Component) {
    ...
    function Select() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), 'onSelect', function(
        value,
      ) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), 'saveList', function(
        node,
      ) {
        _this.list = node;
      });
